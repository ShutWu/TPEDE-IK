...
class objective_function_Panda_quaternion:
	def __init__(self, given_position, given_orientation):
		...
		self.given_position = given_position
		self.R_target = given_orientation
		self.T_target = np.quaternion(0, given_position[0], given_position[1], given_position[2])
